...
Park.prototype.totalVisitorsPerYear = function(dailyVisitorCount){
  return dailyVisitorCount * 365;
};

Park.prototype.totalRevenuePerYear = function(yearlyVisitorCount){
  return yearlyVisitorCount * this.ticketPrice;
};
